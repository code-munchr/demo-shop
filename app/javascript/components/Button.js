    ...
    <div className="select-city">
      ...
      <select className="list_of_cities">
        ...
        <optgroup label="Arkansas">
          <option>Little Rock</option>
          <option>htmlFort Smith</option>
          <option>Fayetteville</option>
          <option>Springdale</option>
          <option>Jonesboro</option>
        </optgroup>
        <optgroup label="CalihtmlFornia">
          <option>Los Angeles</option>
        ...
        <optgroup label="Colorado">
          ...
          <option>htmlFort Collins</option>
          <option>Lakewood</option>
        </optgroup>
        <optgroup label="Connecticut">
          <option>Bridgeport</option>
          <option>New Haven</option>
          <option>HarthtmlFord</option>
          <option>StamhtmlFord</option>
        ...
        <optgroup label="Illinois">
          <option>Chicago</option>
          <option>Aurora</option>
          <option>RockhtmlFord</option>
          <option>Joliet</option>
          <option>Naperville</option>
        </optgroup>
        <optgroup label="Indiana">
          <option>Indianapolis</option>
          <option>htmlFort Wayne</option>
        ...
        <div className="modal-body">
          <htmlForm action="#" method="post">
            <div className="htmlForm-group">
              <label className="col-htmlForm-label">Username</label>
              <input type="text" className="htmlForm-control" placeholder=" " name="Name" required=""/>
            </div>
            <div className="htmlForm-group">
              <label className="col-htmlForm-label">Password</label>
              <input type="password" className="htmlForm-control" placeholder=" " name="Password" required=""/>
            </div>
            <div className="right-w3l">
              <input type="submit" className="htmlForm-control" value="Log in"/>
            </div>
    ...
    <div className="modal-dialog" role="document">
      <div className="modal-content">
        ...
        <div className="modal-body">
          <htmlForm action="#" method="post">
            <div className="htmlForm-group">
              <label className="col-htmlForm-label">Your Name</label>
              <input type="text" className="htmlForm-control" placeholder=" " name="Name" required=""/>
            </div>
            <div className="htmlForm-group">
              <label className="col-htmlForm-label">Email</label>
              <input type="email" className="htmlForm-control" placeholder=" " name="Email" required=""/>
            </div>
            <div className="htmlForm-group">
              <label className="col-htmlForm-label">Password</label>
              <input type="password" className="htmlForm-control" placeholder=" " name="Password" id="password1" required=""/>
            </div>
            <div className="htmlForm-group">
              <label className="col-htmlForm-label">Confirm Password</label>
              <input type="password" className="htmlForm-control" placeholder=" " name="Confirm Password" id="password2" required=""/>
            </div>
            <div className="right-w3l">
              <input type="submit" className="htmlForm-control" value="Register"/>
            </div>
            <div className="sub-w3l">
              <div className="custom-control custom-checkbox mr-sm-2">
